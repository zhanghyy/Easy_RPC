...
from .fun_manage import fun_push
...
class RpcMethod(object):
    ...
    def push_fun(self):
        ...
        :return:
        """
        resinfo = fun_push(self._method.__name__)
    ...
    def call(self, *args, **kwargs):
        if self._methodType == self.TYPE_WITH_CLASS:
            ...
            if self._isCoroutine:
                resp = EventLoop.runUntilComplete(
                    operator.methodcaller(self._method.__name__, *args, **kwargs)(classInstance))
            else:
